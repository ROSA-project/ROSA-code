...
\node[rootClass ] (Position) [right=of Shape] {
	\input{nodes/Position}
};

\node[rootClass ] (InIn) [left=of World] {
	\input{nodes/IntersectionInstance}
};

\node[rootClass ] (WorldState) [right=of World] {
	\input{nodes/WorldState}
};
